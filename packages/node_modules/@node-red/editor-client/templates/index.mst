...
// Función para obtener los flujos desde Node-RED
...
// Función para obtener los flujos desde el backend personalizado
...
// Función para mostrar la lista de flujos de Node-RED en una ventana emergente
            ...
            listItem.onclick = async function() {
                try {
                    ...
                    const datosNuevoRecurso = {
                        ...
                        nodes: JSON.stringify(transformedJson)  // Usar el JSON transformado
                    };
...
async function showFlowListLoad() {
    try {
        ...
        const flows = responseData.data; // Acceder al array de flujos dentro de la propiedad 'data'
        ...
        flows.forEach(function(flow) {
            const listItem = document.createElement('li');
            listItem.textContent = flow.name; // Acceder al nombre de cada flujo
            listItem.className = 'list-group-item';
            listItem.style.cursor = 'pointer';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    saveButton.addEventListener('click', function() {
        // Mostrar la ventana emergente con la lista de flujos al hacer clic en el botón de guardar
        showFlowList();
    });

    loadButton.addEventListener('click', function() {
        // Mostrar la ventana emergente con la lista de flujos al hacer clic en el botón de cargar
        showFlowListLoad();
    });
});
...
function transformJson(json) {
    // Crear el primer objeto del array que contiene la información del "tab"
    const tab = {
        id: json.id,
        type: "tab",
        label: json.label,
    ...
    // Crear un array que contenga el objeto "tab" y los nodos
    const result = [tab, ...json.nodes];
