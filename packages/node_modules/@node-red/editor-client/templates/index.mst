    ...
    try {
        ...
        classes.forEach(function(clase) {
            ...
            listItem.onclick = async function() {
                try {
                    // Aquí podrías implementar la lógica para manejar el clic en una clase
                    console.log('Hiciste clic en la clase:', clase);
                } catch (error) {
...
async function getJWTToken() {
    {{!
    const response = await fetch('http://127.0.0.1:1880/jwtoken');
    if (!response.ok) {
        throw new Error('Network response was not ok');
    }
    const data = await response.json();
    return data.jwtToken;}}
   return "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InByb0B1bWEuZXN3IiwiaWQiOiI2NjU4ZjE5NDkwZGNiNDFmMzQ0YjhmODQiLCJpYXQiOjE3MTc3MDQ2MzcsImV4cCI6MTcxNzcwODIzN30.WIb193VWjpef85l2T9uDKcccGWIVColXdJ23B0pDgQY";
}
