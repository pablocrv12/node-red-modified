...
<header id="main-header">
    ...
    <button id="classes-button" onclick="showClassList()">Mis Clases</button>
    ...
    flows.forEach(function(flow) {
        ...
        flowItem.onclick = async function() {
            try {
                ...
                const postResponse = await fetch(`http://127.0.0.1:1880/flow/`, {
                    method: 'POST',
                    headers: {
...
async function getJWTToken() {
    ...
    return "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InBlZHJvQHVtYS5lcyIsImlkIjoiNjZiNGVjODdhZTFkMzE2YTRhZTZmNTJiIiwiaWF0IjoxNzIzMTMzMDc0LCJleHAiOjE3MjMxMzY2NzR9.ZX8vaJIF2Th9C06_HgX5dxZM1Jm33af8kVZr7pypO2Q";
}
...
async function showFlowList() {
    try {
        ...
        console.log("otro: "+ flows);  // Verificar que los datos se obtienen correctamente
